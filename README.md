...
* 🚀В настоящее время работаю над разработкой модулей для UnicoreCMS: [Демо версия](https://demonicparadise.online)

### Услуги
* ⚡ Установка UnicoreCMS - 2000
* ⚡ Модуль для UnicoreCMS: "Заявка в персонал" - 2500
* ⚡ Модуль для UnicoreCMS: "Команда проекта" - 3000
* ⚡ Модуль для UnicoreCMS: "Пополнение через ЮКасса" - 2000
...
* ⚡ ~Модуль для UnicoreCMS: "Модуль скринов с сервера" - 1500~
* ⚡ ~Модуль для UnicoreCMS: "Страница Wipe с управлением через адмику" - 4500~
* ⚡ ~Модуль для UnicoreCMS: "Я застрял" - 1500~
* ⚡ ~Модуль для UnicoreCMS: "Ежедневные награды управлением с сайта на сервере" - 2500~
* ⚡ ~Модуль для UnicoreCMS: "Привязка соц. сетей" - 3500~
* ⚡ ~Модуль для UnicoreCMS: "Бот для дс" - 2000~
* ⚡ ~Модуль для UnicoreCMS: "Модуль на кейсы" - 4500~
